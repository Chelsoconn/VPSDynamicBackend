...
var pg_1 = require("pg");
var queries_1 = require("../SQLqueries/queries");
...
// seedMongoDB();
var PORT = 3001;
app.get('/api/users', function (_, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, err_1, error;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, queries_1.getAllUsers)(client)];
            case 1:
                result = _a.sent();
...
app.get('/api/users/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, queries_1.getSingleUser)(client, req.params.id)];
            case 1:
                response = _a.sent();
